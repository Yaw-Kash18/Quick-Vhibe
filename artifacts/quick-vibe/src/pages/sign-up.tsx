...
import { Mail, Lock, Eye, EyeOff, Loader2, MessageSquare, CheckCircle2, Shield, Zap, Users } from "lucide-react";
...
export default function SignUpPage() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      setError(err.errors?.[0]?.message || "Google sign up is not available.");
          ...
          {step === "form" ? (
            ...
            >
              ...
              <div className="relative flex items-center gap-3">
                ...
                <span className="text-xs text-muted-foreground/60 flex-shrink-0">or sign up with email</span>
                <div className="flex-1 border-t border-border/40" />
              </div>
              ...
              <form onSubmit={handleVerify} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="h-12 text-center text-xl tracking-[0.4em] font-mono bg-card border-border/50 focus-visible:ring-primary/40"
                    maxLength={6}
