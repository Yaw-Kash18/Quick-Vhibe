...
import { X, Shield, UserMinus, Users, UserPlus, Search, Loader2 } from "lucide-react";
import {
            ...
            {isLoading ? (
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="flex flex-col items-center py-6 px-4 border-b border-border/20">
                  ...
                  {group.description && <p className="text-sm text-muted-foreground text-center mt-1">{group.description}</p>}
